...
function HeaderSecondRow() {
  const [showSetupMenu, setShowSetupMenu] = useState(false);
  const [showOrganizationalSubMenu, setShowOrganizationalSubMenu] =
    useState(false);
  ...
  return (
    <div className="second-row">
      <div className="content">
          ...
          {showSetupMenu && (
            <div className="dropdown-menu-container">
              ...
              >
                ...
                {showOrganizationalSubMenu && (
                  <div className="submenu">
                    ...
                    <a className="dropdown-item" href="/sectors/all/generalAd">
                      الإدارة العامة
                    </a>
                    <a
                      className="dropdown-item"
                      href="/sectors/generalAd/all/subAd"
                    >
                      الإدارات الفرعية
                    </a>
                    <a
                      className="dropdown-item"
                      href="/sectors/generalAd/subAd/all/department"
                    >
                      الأقسام
                    </a>
                  </div>
              ...
              >
                ...
                {showJobStructure && (
                  <div className="submenu">
                    <a className="dropdown-item" href="/job-groups">
                      المجموعات الوظيفية
                    </a>
                    <a
                      className="dropdown-item"
                      href="/job-groups/all/job-sub-groups"
                    >
                      المجموعات النوعية
                    </a>
                    <a
                      className="dropdown-item"
                      href="/job-groups/job-sub-groups/all/job-names"
                    >
                      المسميات الوظيفية
                    </a>
                  </div>
              ...
              <a className="dropdown-item" href="/fintial-degrees">
                {" "}
                الدرجات الوظيفية{" "}
              </a>
              ...
              >
                ...
                {showQualification && (
                  <div className="submenu">
                    <a className="dropdown-item" href="/educational-level">
                      المؤهل العلمي
                    </a>
                    <a
                      className="dropdown-item"
                      href="/educational-level/all/certificate"
                    >
                      المؤهل الدراسي
                    </a>
                  </div>
        ...
        <div className="menu-item">
          <a className="dropdown-item" href="/details-of-employee">
            البحث
          </a>
        </div>
